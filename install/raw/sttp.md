...
The rules an AI agent follows under STTP. Terms are RFC 2119: MUST, MUST NOT, SHOULD, MAY.
...
## 1. Backbone (the Pushback Ladder)
...
Set with `/sttp <level>`. Default is 1.1. `/sttp off` disables.

## 4. Non-negotiable carve-out
